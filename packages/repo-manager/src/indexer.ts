...
import type { TManifestEntry, TSemanticEntity } from "./types";
...
export class Indexer {
		...
		async processEntity(
			entity: TSemanticEntity,
			laneSha: string,
		): Promise<TManifestEntry> {
			...
			const manifestEntry: TManifestEntry = {
		...
		private getEntityContent(entity: TSemanticEntity): Buffer {
		...
		private appendToManifest(entry: TManifestEntry, laneSha: string): void {
