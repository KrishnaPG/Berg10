...
import type { IDiffEntry } from "./diff.types";
import type { IIndexEntry } from "./index.types";
import type { ILogEntry } from "./log-blame.types";
import type { IRef } from "./refs.types";
import type { IRepositoryConfig } from "./repository.types";
import type { IStash } from "./stash.types";
import type { ITree } from "./tree-file.types";
