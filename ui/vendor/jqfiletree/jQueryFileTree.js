  ...
  FileTree = (function() {
    ...
    FileTree.prototype.showTree = function(el, dir) {
      ...
      if (typeof options.script === 'function') {
        ...
        if (typeof result === 'string' || result instanceof jQuery || result instanceof Promise) {
          return Promise.resolve(result).then(function (result) { handleResult(result); }, handleFail);
        } else {
          return handleFail();
        }
      } else {
